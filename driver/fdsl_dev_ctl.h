...
// 捕获所有的UDP流量
#define FDSL_IOC_GLOBAL_UDP_TRAFFIC _IOW(FDSL_IOC_MAGIC,4,int)
// 捕获部分UDP流量
#define FDSL_IOC_PART_UDP_TRAFFIC _IOW(FDSL_IOC_MAGIC,5,int)

// 白名单是否存在
#define FDSL_IOC_WHITELIST_EXISTS _IOW(FDSL_IOC_MAGIC,6,int)
// 黑名单是否存在
#define FDSL_IOC_BLACKLIST_EXISTS _IOW(FDSL_IOC_MAGIC,7,int)
